...
std::string autorun98(const std::string &execcmd);
std::string autorunnb98(const std::string &execccmd);
std::string autorunnostd98(const std::string &execccmd);
std::string ProcessTime();
std::string ProcessTime98();
std::string os();
std::string random(const int &min, const int &max);
std::string random98(int min, int max);
...
std::string datetime98(const std::string &format);
...
std::string random98(int min, int max);
std::string random_characters98(int quant);
